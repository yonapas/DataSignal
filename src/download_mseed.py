...
def getMseedFromWeb(magnitude, date):
	...
	inventory = flink.get_stations(ot-1, ot+550, network='*', station='*', location='*', channel='???', level='response')
...
# getMseedFromWeb(5.1, '2012-03-22T04:15:00')
