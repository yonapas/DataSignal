...
def SavePlotOriNew(ori_trace, filter_trace, nevent, lowpass=None, highpass=None, timecut=None):
	...
	axarr[0,0].set_title('{0} {1} ,dt:{2}'.format(sta, nevent, dt))
